        ...
        <header className='lg:w-[95%] md:p-0 p-10 w-full h-full justify-center lg:flex grid relative z-10'>
          ...
          <div data-aos="fade-up-right" data-aos-duration="600" className='grid content-center place-self-center'>
            ...
            <span className='relative z-20'>
              <h3 className='text-white font-poppins-regular md:text-[32px] text-[25px] lg:text-left text-center mb-4'>Web Developer / Programmer</h3>
            </span>
            
            <Link className='contact-btn w-fit md:place-self-start justify-self-center relative overflow-hidden hover:text-[#272829] z-[100] border-[5px] border-yellow-text font-poppins-regular text-yellow-text md:text-[22px] text-[22px] rounded-lg px-6 py-3 mt-5 grid hover-text'>Contact Me</Link>
          ...
          <SocialLogos display = "grid" hidden = "block" margin = "ml-10" responsive="hidden" />
